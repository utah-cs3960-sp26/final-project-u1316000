...
def build_user_prompt(packet: dict[str, Any]) -> str:
    ...
    return (
        ...
        "If reveal_guardrails are present in the packet, obey them strictly. Early patrol pressure, one strange machine sighting, and a first breadcrumb from the hat are okay. Naming the ruler behind the patrols or fully explaining the backstory is not okay yet.\n"
...
def build_validation_retry_user_prompt(
    *,
    ...
    return (
        ...
        "- Obey reveal_guardrails when present in the packet. Early patrol pressure, one strange machine sighting, and a first breadcrumb from the hat are okay. Naming the ruler behind the patrols or fully explaining the backstory is not okay yet.\n\n"
